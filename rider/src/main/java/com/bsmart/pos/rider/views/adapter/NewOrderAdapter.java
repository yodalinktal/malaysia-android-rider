 ...
 */
public class NewOrderAdapter extends ArrayAdapter<OrderBean> {

    private int resourceId;
    ProgressDialog progressDialog;

    public NewOrderAdapter(@NonNull Context context, int resource, @NonNull List<OrderBean> objects) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        viewHolder.btnOperation.setText("Accept");
        if (orderBean.getStatus().equals(OrderStatusConstant.WAITING)){
            viewHolder.btnOperation.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {

                    acceptOrder(orderBean, NewOrderAdapter.this);
    ...
    private void acceptOrder(final OrderBean orderBean,final NewOrderAdapter orderAdapter){

        AlertDialog.Builder builder = new AlertDialog.Builder(getContext());
        builder.setTitle("Info");
        builder.setMessage("Are you sure Accept Job?");
